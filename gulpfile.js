...
gulp.task('default', ['cssPack', 'packReact'], function() {
    ...
    gulp.watch(devJS + '*.jsx', ['packReact']);
    gulp.watch(devJS + 'views/*.jsx', ['packReact']);
    gulp.watch(devJS + 'routes/*.jsx', ['packReact']);
    gulp.watch(devJS + 'store/*.jsx', ['packReact']);
})